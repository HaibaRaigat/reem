...
.
  ...
  'review.ensuringAnonymousReview' => 'Assurer un examen aveugle',
  ...
  'review.anonymousPeerReview' => '<p>Afin d\'assurer l\'intégrité de l\'évaluation par les pairs en double-aveugle des soumissions envoyées à cette revue, tous les efforts possibles devraient être faits pour éviter de révéler l\'identité des auteurs et auteures et des évaluateurs et évaluatrices Cela implique que les auteurs et auteures, éditeurs et éditrices et évaluateurs et évaluatrices (qui téléversent des documents dans le cadre de leur évaluation) vérifient si les étapes suivantes ont été prises en ce qui concerne le texte et les propriétés du fichier :</p>
<ul><li>Supprimer le nom de l\'auteur ou auteure du texte. Dans la bibliographie et dans les notes en bas de page, on utilise le mot  « Auteur(-e) » et l\'année au lieu du nom de l\'auteur-e, du titre de l\'article, etc.</li>
<li>L\'identification de l\'auteur ou auteure ne doit plus apparaître dans les propriétés du fichier en suivant les étapes suivantes :
...
caractères que vous avez saisis ne correspondent pas aux caractères "
l\'image. Veuillez vérifier les caractères et essayer de nouveau."',
  ...
  'form.missingRequired' => 'Ce champ est requis.',
  'form.errorUnknown' => '
erreur inattendue est survenue. Vous avez peut-être été déconnecté ou "
