<?php return array (
  ...
  'grid.genres.description' => '
genres sont utilisés pour nommer les fichiers et sont présentés dans "
menu déroulant au moment de télécharger les fichiers. Les genres "
par les symboles ## permettent à l\'utilisateur d\'associer le "
au livre complet 99Z ou à un chapitre particulier (ex.: 02)."',
  'grid.user.mergeUsers.into.description' => '
vous devez sélectionner un utilisateur à qui vous attribuerez "
paternité des ouvrages, les tâches de révision, etc."',
  'grid.user.mergeUsers.from.description' => '
un utilisateur qui sera fusionné à un autre compte "
(ex.: lorsqu\'une personne a deux comptes d\'utilisateur). Le "
compte sélectionné sera supprimé et ses soumissions, tâches, etc. "
attribuées au second compte."',
  'grid.user.mergeUsers.mergeUserSelect.confirm' => '
voulez vraiment fusionner cet utilisateur à un autre? Vous choisirez "
prochain utilisateur sur l\'écran suivant."',
  'grid.user.mergeUsers.noneEnrolled' => 'Aucun utilisateur avec ce rôle n\'existe',
  'grid.preparedEmails.description' => '
presse facilite le bon déroulement de la communication par l\'usage de "
électroniques rédigés à l\'avance. La formulation par défaut des "
peut facilement être modifée ci-dessous."',
);