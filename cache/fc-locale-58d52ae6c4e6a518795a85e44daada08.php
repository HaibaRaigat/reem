<?php return array (
  ...
  'editor.review.notInitiated' => 'Le processus de révision n\'a pas encore débuté.',
  ...
  'editor.submissionReview.anonymous' => 'Évaluation à l\'aveugle',
  'editor.submissionReview.doubleAnonymous' => 'Évaluation en double aveugle',
  ...
  'editor.review.uploadRevision' => 'Transférer la révision',
  ...
  'editor.review.dateAccepted' => 'Date d\'acceptation de la révision',
  'editor.review.reviewsAdded' => 'Les rapports ont été ajoutés au corps du message.',
  'editor.review.noReviews' => 'Aucune révision des pairs à importer',
  ...
  'editor.review.unconsiderReviewText' => 'Vous souhaitez indiquer que cet examen n\'a pas été considéré ? L\'historique des révisions sera conservé.',
  'editor.review.unconsiderReview' => 'Ne pas considérer cet examen',
  'editor.review.readConfirmation' => 'Après avoir lu cet examen, choisissez "Confirmer" pour indiquer que le processus d\'examen peut se poursuivre.',
  ...
  'editor.submissionLibrary.description' => '
les documents qui concernent la révision et la publication de "
soumission. Des modèles ont été créés pour plusieurs de ces "
Il suffit de cliquer sur <em>Visionner la bibliothèque de "
',
  'editor.submission.review.reviewFilesDescription' => '
les fichiers qui peuvent être sélectionnés pour l\'évaluation, "
vous ajoutez des rapporteurs dans la section <span class="
',
  'editor.submission.revisionsDescription' => '
fichiers révisés de la soumission sont affichés ici. L\'icône Ouvrir "
dossier indique qui a téléchargé le fichier."',
  'editor.submission.editorial.introduction' => '
la section Rédaction, le réviseur de textes examine les épreuves "
avant de les télécharger dans la rubrique <span class="
L\'auteur et d\'autres personnes ont "
aux fichiers dans <span class="pkp_help_title">Révision</span> "
que l\'on puisse éventuellement préparer et télécharger les copies au "
de la soumission. Elles seront ensuite <em>Approuvées</em> par un "
en chef, et passeront à l\'étape de publication."',
  'editor.submission.editorial.approveCopyeditFile' => 'Approuver le fichier révisé',
  'editor.submission.editorial.copyeditingDescription' => '
les fichiers révisés à leurs auteurs (et à d\'autres personnes, "
cas échéant) afin qu\'ils examinent les modifications et répondent aux "
Leurs réponses et fichiers téléchargés s\'afficheront dans "
Carnet. Ils seront identifiés <em>Considéré</em> par le réviseur, "
préparera ensuite une copie au net finale qui pourra être téléchargée "
<span class="pkp_help_title">Révision</span>. Le rédacteur en chef "
cette copie et l\'approuvera, puis elle passera à l\'étape de "
',
  'editor.submission.final.manageFinalDraftFilesDescription' => '
fichier qui a été téléchargé à une étape du processus de soumission, "
importe laquelle, peut être ajouté à la liste des fichiers d\'épreuves "
Il suffit de cocher la case Ajouter ci-dessous, puis de cliquer "
tous les fichiers disponibles seront affichés et peuvent être "
pour être ajoutés. Les autres fichiers qui n\'ont pas déjà été "
à une certaine étape du processus peuvent être ajoutés à "
liste en cliquant sur le lien Télécharger une épreuve finale."',
  'editor.signoff.approved' => 'Approuvé',
  'editor.submission.selectAttachments' => 'Choisir les fichiers d\'évaluation que l\'auteur pourra consulter',
  'editor.submission.selectFairCopy' => '
les fichiers de révision approuvés qui seront envoyés pour la "
',
  'editor.submission.review.manageReviewFilesDescription' => '
les fichiers qui ont déjà été téléchargés à une étape du processus "
soumission (même à une étape d\'édition ou de publication) peuvent être "
pour révision. Il suffit de cocher la case Ajouter ci-dessous, "
de cliquer Recherche: tous les fichiers disponibles seront affichés "
peuvent être choisis pour être ajoutés. Les autres fichiers qui n\'ont "
déjà été téléchargés à une certaine étape du processus peuvent être "
à cette liste en cliquant sur le lien Télécharger le fichier "
',
  'editor.submission.selectPromoteRevisions' => 'Choisir les révisions qui seront utilisées à la prochaine étape',
  'editor.submissionReview.restrictFiles.gridDescription' => '
ce rapporteur ne devrait pas avoir le droit de réviser tous les "
apparaissant dans cette liste, assurez-vous de cocher uniquement "
fichiers pertinents."',
  'editor.review.NotifyAuthorAccept' => 'Avertir l\'auteur de l\'acceptation:',
  'editor.review.NotifyAuthorDecline' => 'Avertir l\'auteur que sa soumission a été refusée:',
  'editor.review.NotifyAuthorExternal' => 'Avertir l\'auteur que l\'on a décidé de mener un examen externe',
  'editor.review.personalMessageToAuthor' => 'Envoyer un courriel à l\'auteur',
  'editor.publicIdentificationExistsForTheSameType' => '
public identifié comme \'{$publicIdentifier}\' existe déjà pour un autre "
de même type. Veuillez indiquer un public unique pour l\'objet de "
