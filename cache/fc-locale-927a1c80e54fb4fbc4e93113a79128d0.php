<?php return array (
  ...
  'editor.submissionReview.cannotSendToCopyediting' => 'Avant d\'envoyer une soumission en Révision, utiliser le lien Aviser l\'auteur pour l\'informer de la décision et sélectionner la version à envoyer.',
  ...
  'editor.submission.editorial.finalDraftDescription' => 'Les versions finales sur cette liste sont transformées par un réviseur en versions révisées, téléchargées dans <span class="pkp_help_title">Révision</span>.',
...
de page couverture invalide. Les formats acceptés sont .gif, .jpg, "
.png."',
  'editor.issues.hideCoverPageArchives' => '
pas afficher l\'imagette de la page couverture dans la liste des "
',
  ...
  'editor.article.editorToEnter' => '
rédacteur doit saisir les recommandation/commentaires pour le "
',
...
à nouveau le fichier sélectionné pour évaluation par les pairs"',
  ...
  'editor.article.showCoverPage' => '
une page couverture pour cet article avec les éléments suivants."',
  ...
  'editor.article.hideCoverPageAbstract' => '
pas afficher l\'image de la page couverture lors de l\'affichage du "
de l\'article."',
