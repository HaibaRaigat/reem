<?php return array (
  ...
  'default.contextSettings.checklist.notPreviouslyPublished' => 'La soumission n\'a pas déjà été publiée et n\'est pas considérée actuellement par une autre revue. Si ce n\'est pas le cas, fournir une explication dans le champ "Commentaires au rédacteur".',
  'default.contextSettings.checklist.fileFormat' => 'Le fichier de la soumission est dans un des formats de fichier suivants : OpenOffice, Microsoft Word, RTF ou WordPerfect.',
  'default.contextSettings.checklist.addressesLinked' => 'Lorsque possible, les URLs des références ont été fournies.',
  'default.contextSettings.checklist.submissionAppearance' => 'Le texte est à simple interligne, utilise une police de 12 points, emploie l\'italique plutôt que le souligné (sauf pour les adresses URL) et place toutes les illustrations, figures et tableaux aux endroits appropriés dans le texte plutôt qu\'à la fin.',
  'default.contextSettings.checklist.bibliographicRequirements' => 'Le texte se conforme aux exigences stylistiques et bibliographiques décrites dans les  <a href="{$indexUrl}/{$contextPath}/about/submissions#authorGuidelines">Directives aux auteurs</a>, qui se trouvent dans la section « À propos de la revue ».',
...
<a href="{$contextUrl}">{$contextName}</a>',
  ...
  'default.journalSettings.emailHeader' => '
message suivant est délivré au nom de {$journalName}.
"
',
  'default.groups.name.committeemember' => 'Membre du Comité de Rédaction',
  'default.groups.plural.committeemembers' => 'Membres du Comité de Rédaction',
  'default.groups.abbrev.committeemembers' => 'Membres du Comité',
