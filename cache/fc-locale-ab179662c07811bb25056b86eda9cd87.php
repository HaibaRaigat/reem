<?php return array (
  ...
  'admin.auth.defaultSourceDescription' => '<p>Définir une source d\'authentification par défaut autre que celle d\'OJS a pour conséquence :</p>
<ul>
...
<ol>
  ...
  'sectionEditor.copyedit.confirmRenotify' => 'Notifier de nouveau ce réviseur redémarrera la tâche qui lui a été assignée. Êtes-vous certain de vouloir le faire ?',
...
<p>Si vous n\'êtes pas déjà inscrit et voulez recevoir des nouvelles et mises à jour, <strong>veuillez vous inscrire à <a href="http://pkp.sfu.ca/ojs/register" target="_new">http://pkp.sfu.ca/ojs/register</a>. </strong>Pour toute question ou commentaire, veuillez visiter le <a href="http://forum.pkp.sfu.ca" target="_new">forum de support</a>.</p>',
  ...
  'user.authorization.copyeditorAssignmentMissing' => 'Accès refusé ! Vous n\'avez pas été nommé rédacteur/réviseur de cet article.',
  ...
  'admin.settings.oaiRegistrationDescription' => '
indexer le contenu de toutes les revues hébergées sur ce site selon "
système distribué de bases de données de recherche, <a href="http://"
target="_blank">inscrire</a> l\'adresse "
de votre site dans le <a href="http://pkp.sfu.ca/harvester/" target="
de métadonnées du Public Knowledge Project. Cet "
récolte les métadonnées de chaque article indexé de la revue, "
ainsi une recherche précise et globale parmi les sites de "
qui adhèrent au protocole de collecte de métadonnées du <a href="

Archives Initiative</a>.
"
/><br />
"
href="http://pkp.sfu.ca/harvester/add.php" target="_blank">Cliquer "
et saisir <span class="highlight">{$siteUrl}</span> sous "
URL</b>, et <span class="highlight">{$oaiUrl}</span> sous "
URL for OAI Archive</b>.
"
/><br />
"
noter que l\'interface OAI peut être désactivée pour ce site en "
la configuration OJS. Les futures versions d\'OJS permettront "
ou de désactiver l\'interface OAI pour chacune des revues du "
',
  'plugins.block.information.link' => 'Information',
  'manager.setup.lockssDescription' => '
Journal Systems prend en charge le système <a href="http://lockss."
target="_blank">LOCKSS</a> (Lots of Copies Keep Stuff Safe) afin "
l\'archivage sécuritaire et permanent pour la revue. LOCKSS est "
logiciel libre développé à la bibliothèque de l\'Université Stanford "
permet aux bibliothécaires de préserver des revues numériques "
en interrogant régulièrement les sites Web des revues "
pour du contenu récemment publié et en l\'archivant. Chaque "
est continuellement validée  par rapport aux caches des autres "
et si son contenu est corrompu ou perdu, les autres caches "
la revue sont utilisés pour le restaurer.
"
/><br />
"
configuration de la prise en charge de LOCKSS pour Open Journal "
n\'a pas à être effectuée avant que le processus de publication "
bien enclenché, en quel cas, suivre ces deux étapes :"',
  'manager.setup.registerJournalForIndexingDescription' => '
que le contenu de cette revue soit indexé dans un système distribué "
bases de données de recherche, veuillez lire <a href="http://www.oclc."
target="_blank">les étapes pour "
un fournisseur de données</a> et inscrire votre revue avec le <a "
target="
Open Archives</a> officiel. Pour vous inscrire, vous "
besoin de l\'URL de base de votre dépôt : <span class="highlight"

la suite, vous pouvez inscrire votre revue au <a href="http://gita."
target="_blank">registre UIUC OAI</"
href="http://www.oclc.org/oaister" target="_blank">OAIster</"

/><br />
"
note que si votre administrateur de site a déjà inscrit ce site "
de ces services, votre revue sera indexée automatiquement et vous "
pas besoin d\'inscrire votre revue."',
  'editor.article.selectReviewerNotes' => '
des liens vers le profil de l\'évaluateur.<br />
"
est sur 5 (Excellent).<br />
"
réfèrent au temps moyen nécessaire pour compléter une évaluation."
/>
"
est la date de la plus récente évaluation acceptée.<br />
"
indique combien d\'évaluations sont présentement considérées ou en "
',
  'copyeditor.article.uploadedFile' => 'Fichier déposé',
  'user.register.loginToRegister' => '
vos nom d\'utilisateur et mot de passe actuels pour vous inscrire à "
revue"',
  'about.onlineSubmissions' => 'Soumissions en ligne',
  'log.review.reviewCancelled' => '
cycle {$round} d\'évaluation par {$reviewerName} pour la soumission "
a été annulé."',
  'plugins.categories.citationFormats.description' => '
modules de format de citation fournissent aux utilisateurs différents "
par lesquels ils peuvent accéder aux citations d\'articles."',
  ...
  'manager.setup.subjectClassificationDescription' => '
revue utilisera un système de classification sujet disponible sur le "
/>
"
du système de classification"',
  'rt.admin.validateUrls.description' => '
URLs de sites de recherche possiblement invalides sont affichés ci-"
/>
"
devriez vérifier manuellement tous les URLs indentifiés comme "
car ce test n\'est pas fiable à 100%.<br />
"
validation peut échouer sur les URL de recherche qui nécessitent des "
de données enregistrés."',
  'notification.mailListDescription' => '
votre adresse de courriel pour être avisé immédiatement de tout "
contenu important ajouté à la revue."',
  'notification.notificationsPublicDescription' => '
page montre les mises à jour importantes associées avec cette revue "
que les nouvelles parutions et les annonces. Vous pouvez vous abonner "
ces avis par l\'intermédiaire des flux RSS (en cliquant sur les images à "
ou <a href="{$emailUrl}">par courriel.</a>"',
  ...
  'gifts.thankYouMessage' => '
procédure d\'achat cadeau est complétée. Vous recevrez une copie du "
d\'accompagnement envoyé au bénéficiaire après traitement de "
règlement."',
  'gifts.purchaseGiftIndividualSubscription' => 'Abonnement en cadeau',
  'gifts.subscriptionFormIntroduction' => '
remplir le formulaire ci-dessous et fournir les coordonnées "
Le bénéficiaire recevra votre carte-cadeau par courriel et "
avisé de l\'abonnement offert."',
  'gifts.details' => 'Description du cadeau',
  'gifts.detailsDescription' => '
sélectionner le cadeau ci-dessous et fournir un message "
qui sera envoyé par courriel au bénéficiaire (vous recevrez "
copie de ce courriel)."',
  ...
  'gifts.subscriptionsDescription' => '
validation ici d\'un abonnement en cadeau rendra caduque votre "
actuel (si vous en avez un). L\'abonnement sera valide du jour "
la validation au terme de la durée stipulée selon le type d\'abonnement "
',
  'gifts.purchaseGiftSubscription' => 'Offrir un abonnement en cadeau',
  'gifts.giftSubscriptionsAvailable' => '
est aussi possible d\'offrir un abonnement en cadeau, que le "
sera libre de valider en tout temps. Voilà un excellent "
de soutenir cette revue!"',
  ...
  'gifts.subscriptionTypeNotValid' => '
formule cadeau sélectionnée ne permet pas ce type d\'abonnement. "
contacter le responsable des abonnements."',
  'gifts.subscriptionNonExpiring' => '
cadeau n\'a pu être validé en raison de votre abonnement illimité à "
revue."',
...
Journal Systems prend également en charge le système <a href="
target="_blank"> CLOCKSS </a> (Controlled Lots "
Copies Keep Stuff Safe) pour assurer un archivage sécurisé et "
pour le journal. CLOCKSS est basé sur le logiciel open source "
développé à la bibliothèque de l\'Université de Stanford, qui "
aux bibliothèques de préserver des revues Web en sondant "
les sites Web de revues enregistrées pour les contenus "
publiés, pour ensuite les archiver. Chaque archive est "
validée par rapport à d\'autres caches et si le contenu "
corrompu ou perdu, les autres caches ou le journal sont utilisés pour "
restaurer.
"
/> <br />
"
de CLOCKSS pour Open Journal Systems n\'a pas besoin "
lieu avant que la publication soit en cours."',
  'manager.setup.citations.enable' => '
l\'Assistant au balisage de référence (Citation Markup Assistant)"',
  'manager.setup.porticoDescription' => '
est un service sans but lucratif voué à la préservation des "
numériques, y compris les revues électroniques, les livres "
et les collections historiques numérisées. Si votre revue a "
un contrat avec Portico, activez-le ici :"',
);